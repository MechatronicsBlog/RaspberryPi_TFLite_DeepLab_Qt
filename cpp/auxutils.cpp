...
QImage AuxUtils::drawSegmentation(QImage image, QImage segmentation)
{
    QPainter p;

    // Scale segmentation mask to image size
    QImage mask = segmentation.scaled(image.size(),Qt::IgnoreAspectRatio,Qt::FastTransformation);
