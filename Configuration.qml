       ...
       SwipeView {
         ...
         Flickable {
             ...
             Column{
                 ...
                 CheckBox{
                     id: chbSemiTransparent
                     anchors.horizontalCenter: parent.horizontalCenter
                     text: "Semi-transparent objects"
                     checked: semiTransparent
                     onCheckStateChanged: semiTransparent = checked
                 }

                 CheckBox{
                     anchors.left: chbSemiTransparent.left
                     text: "Show real background"
                     checked: showBackground
                     onCheckStateChanged: showBackground = checked
                 }
             }
         }
